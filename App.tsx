  ...
  return (
    ...
    <div className="fixed inset-0 w-full h-dvh bg-black flex flex-col overflow-hidden">
        ...
        <div className="relative flex-1 w-full bg-screen-off overflow-hidden border-b-4 border-gray-800 shadow-[0_10px_20px_rgba(0,0,0,0.5)] z-10">
            ...
            <button 
                onClick={toggleMusic}
                className="absolute bottom-4 left-4 z-[55] w-10 h-10 bg-black/30 border border-white/20 rounded-xl flex items-center justify-center text-neon-green hover:bg-black/50 hover:border-neon-green active:scale-95 transition-all shadow-lg backdrop-blur-md"
                title={isMusicEnabled ? "Tắt nhạc nền" : "Bật nhạc nền"}
            >
                {isMusicEnabled ? (
                     // Loa bật (Volume Up) - Icon chuẩn Material Design
